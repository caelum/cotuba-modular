insert into capitulos (ordem, nome, markdown, livros_id) values (1, 'Para quê serve oo?', '## Modelagem e Dependências
...
insert into capitulos (ordem, nome, markdown, livros_id) values (2, 'SOLID', '## Os dez (ou onze) mandamentos de Orientação a Objetos
...
insert into capitulos (ordem, nome, markdown, livros_id) values (3, 'Referências', 'MARTIN, Robert Cecil. _The Principles of OOD_. 2005. Em: <http://butunclebob.com/ArticleS.UncleBob.PrinciplesOfOod>.
